  ...
  return (
    <section className="bg-[#050B18] pb-[clamp(100px,12vw,160px)] px-6 overflow-hidden relative">
      <div className="container mx-auto max-w-[1000px]">
        <FadeIn className="relative bg-white/[0.04] rounded-3xl border border-white/10 p-1 backdrop-blur-sm shadow-[0_0_50px_rgba(0,168,142,0.15)]">
        ...
        <FadeIn delay={300} className="max-w-[700px] mx-auto text-center mt-16">
