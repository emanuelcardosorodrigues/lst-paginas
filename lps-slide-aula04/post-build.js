...
console.log(`✓ ${SLUG}: ${css.length} CSS, ${fonts.length} fontes, ${media.length} arquivo(s) de mídia`);
if (media.length === 0) {
  console.log("  (nenhuma mídia ainda: os 12 slots renderizam o placeholder ASSET PENDENTE)");
}
